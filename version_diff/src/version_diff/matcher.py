...
def pair_paragraphs(paras_a, paras_b, model, threshold=0.75, file_a='', file_b='', vector_store=None):
    """
...
def diff_texts(paras_a, paras_b, model, threshold=0.75, file_a='', file_b='', vector_store=None):
    """
    比较两篇文档的正文段落
    ...
    """
    pairs = pair_paragraphs(paras_a, paras_b, model, threshold, file_a, file_b, vector_store=vector_store)
